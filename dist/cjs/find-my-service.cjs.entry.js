...
const FindMyService = class {
    ...
    initializeMap() {
        esriLoader.esriLoader_3(['esri/portal/Portal', 'esri/widgets/Search', 'esri/WebMap', 'esri/layers/FeatureLayer', 'esri/tasks/Locator']).then(([Portal, Search, WebMap, FeatureLayer, Locator]) => {
    ...
    render() {
        return this.council ? (core.h("div", null, core.h("div", { id: 'searchDiv' }), core.h("div", { class: "o-layout-sidebar-after o-layout-sidebar-after--tight" }, this.councilInfo.map((info) => {
            return core.h("div", { id: "councilDiv", class: "o-layout-sidebar-after__secondary" }, this.loadFeatureWidget("councilDiv", info));
        }), core.h("ol", { class: "o-layout-grid o-layout-grid--3 o-layout-sidebar-after__primary" }, this.maps.map((webmap) => {
            return webmap.featureCnt > 0 ? core.h("li", { class: "o-layout-grid__item" }, core.h("div", null, core.h("h3", null, webmap.title), webmap.layers.map((layer) => {
                return layer.features.length > 0 ? core.h("div", null, layer.features.map((feature, i) => {
                    return this.council && layer.title.includes('City Council') ?
                        core.h("div", null)
                        :
                            core.h("div", { id: layer.id + '_' + i }, this.loadFeatureWidget(layer.id + '_' + i, feature), core.h("br", null));
                }))
                    : core.h("div", null);
            })))
                : core.h("div", null, "Services not provided for this address");
        }))))) :
            (core.h("div", null, core.h("div", { id: 'searchDiv' }), core.h("div", null, core.h("ol", { class: "o-layout-grid o-layout-grid--3" }, this.maps.map((webmap) => {
                return core.h("li", { class: "o-layout-grid__item" }, core.h("div", null, core.h("h3", null, webmap.title), webmap.layers.map((layer) => {
                    return layer.features.length > 0 ? core.h("div", null, layer.features.map((feature, i) => {
                        return core.h("div", { id: layer.id + '_' + i }, this.loadFeatureWidget(layer.id + '_' + i, feature), core.h("br", null));
                    }))
                        : core.h("div", { class: "esri-feature esri-widget" }, core.h("br", null), core.h("h4", { class: "esri-feature__title" }, layer.title), core.h("div", { class: "esri-feature__text esri-feature__content-element" }, core.h("div", { class: "esri-feature__main-container" }, "Service not provided for this address")));
                })));
            })))));
    }
...
exports.find_my_service = FindMyService;
