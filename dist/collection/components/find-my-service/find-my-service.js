...
export class FindMyService {
    ...
    render() {
        return this.council ? (h("div", null,
            h("div", { id: 'searchDiv' }),
            h("div", { class: "o-layout-sidebar-after o-layout-sidebar-after--tight" },
                ...
                h("ol", { class: "o-layout-grid o-layout-grid--3 o-layout-sidebar-after__primary" }, this.maps.map((webmap) => {
                    return webmap.featureCnt > 0 ? h("li", { class: "o-layout-grid__item" },
                        h("div", null,
                            h("h3", null, webmap.title),
            ...
            (h("div", null,
                h("div", { id: 'searchDiv' }),
                h("div", null,
                    h("ol", { class: "o-layout-grid o-layout-grid--3" }, this.maps.map((webmap) => {
                            ...
                            h("div", null,
                                ...
                                webmap.layers.map((layer) => {
                                    return layer.features.length > 0 ? h("div", null, layer.features.map((feature, i) => {
                                        ...
                                        : h("div", { class: "esri-feature esri-widget" },
                                            h("br", null),
                                            h("h4", { class: "esri-feature__title" }, layer.title),
                                            h("div", { class: "esri-feature__text esri-feature__content-element" },
                                                h("div", { class: "esri-feature__main-container" }, "Service not provided for this address")));
                                })));
                    })))));
    }
    static get is() { return "find-my-service"; }
    static get originalStyleUrls() { return {
        "$": ["find-my-service.scss"]
    }; }
