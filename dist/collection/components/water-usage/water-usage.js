...
export class WaterUsage {
    ...
    render() {
        return h("div", { id: 'waterUsage' },
            h("h3", null, "Estimate your monthly household water usage"),
            h("h5", null, "To estimate your monthly household water usage, slide the scrollbar next to each question to provide your answer. Calculations update automatically. "),
            h("h4", null, "Showers"),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    ...
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.shower2.gallons)),
                        h("td", null, this.shower2.ccfunits.toFixed(3))))),
            h("h4", null, "Baths"),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(Math.round(this.bath1.gallons))),
                        h("td", null, this.bath1.ccfunits.toFixed(3))),
                    h("tr", null,
                        h("td", { class: "slider" },
                            h("form", null,
                        ...
                        h("td", null, Math.round(this.bath2.value * 4.33 * 18)),
                        h("td", null, this.bath2.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.toilet.value * 30.4 * 12)),
                        h("td", null, this.toilet.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.teeth.gallons)),
                        h("td", null, this.teeth.ccfunits.toFixed(3))))),
            h("h4", null, "Shaving"),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.shaving.gallons)),
                        h("td", null, this.shaving.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.washing.gallons)),
                        h("td", null, this.washing.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.dishwasher.gallons)),
                        h("td", null, this.dishwasher.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.dishes.gallons)),
                        h("td", null, this.dishes.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.clothes.gallons)),
                        h("td", null, this.clothes.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.outdoor.gallons)),
                        h("td", null, this.outdoor.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.dripping.gallons)),
                        h("td", null, this.dripping.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                ...
                h("tbody", null,
                    h("tr", null,
                        ...
                        h("td", null, Math.round(this.leaking.gallons)),
                        h("td", null, this.leaking.ccfunits.toFixed(3))))),
            ...
            h("table", null,
                h("thead", null,
                    h("tr", null,
                        h("th", { class: "slider" }, "Estimated Monthly Water Usage"),
                        h("th", null, Math.round(this.shower2.gallons + this.bath1.gallons + this.bath2.gallons + this.toilet.gallons +
                        ...
                        h("th", null, (this.shower2.ccfunits + this.bath1.ccfunits + this.bath2.ccfunits + this.toilet.ccfunits +
