        ...
        return h("div", { id: 'waterUsage' },
            ...
            h("div", { class: (this.currentIndex.index === 1 ? ' active' : ' inactive') },
                ...
                h("div", { class: "container" },
                    ...
                    h("div", { class: "questions" },
                        h("div", { class: "inputs" },
                            h("input", { type: "range", onInput: ev => this.bath1Input(ev), onChange: ev => this.bath1Input(ev), min: "0", max: this.bath1.max, value: this.bath1.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.bath1.max, "aria-valuenow": "0" }),
                    ...
                    h("div", { class: "questions" },
                        h("div", { class: "inputs" },
                            h("input", { type: "range", onInput: ev => this.bath2Input(ev), onChange: ev => this.bath2Input(ev), min: "0", max: this.bath2.max, value: this.bath2.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.bath2.max, "aria-valuenow": "0" }),
            ...
            h("div", { class: (this.currentIndex.index === 2 ? ' active' : ' inactive') },
                ...
                h("div", { class: "container" },
                    ...
                    h("div", { class: "questions" },
                        h("div", { class: "inputs" },
                            h("input", { type: "range", onInput: ev => this.toiletInput(ev), onChange: ev => this.toiletInput(ev), min: "0", max: this.toilet.max, value: this.toilet.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.toilet.max, "aria-valuenow": "0" }),
            ...
            h("div", { class: (this.currentIndex.index === 3 ? ' active' : ' inactive') },
                ...
                h("div", { class: "container" },
                    ...
                    h("div", { class: "questions" },
                        h("div", { class: "inputs" },
                            h("input", { type: "range", onInput: ev => this.teethInput(ev), onChange: ev => this.teethInput(ev), min: "0", max: this.teeth.max, value: this.teeth.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.teeth.max, "aria-valuenow": "0" }),
            ...
            h("div", { class: (this.currentIndex.index === 7 ? ' active' : ' inactive') },
                ...
                h("div", { class: "container" },
                    ...
                    h("div", { class: "questions" },
                        h("div", { class: "inputs" },
                            h("input", { type: "range", onInput: ev => this.dishesInput(ev), onChange: ev => this.dishesInput(ev), min: "0", max: this.dishes.max, value: this.dishes.value, step: "1", "aria-valuemin": "0", "aria-valuemax": this.dishes.max, "aria-valuenow": "0" }),
                    ...
                    h("div", { class: "questions" },
                        ...
                        h("div", { class: "totals" },
                            ...
                            h("div", { class: "total" },
                                ...
                                " CCF"))))),
            h("div", { class: "container" },
                h("button", { onClick: () => this.currentIndex = Object.assign(Object.assign({}, this.currentIndex), { index: this.currentIndex.index -= 1 }), class: (this.currentIndex.index != 0 ? 'button back ' : ' btn-hidden button back') }, "Previous"),
                h("button", { onClick: () => this.currentIndex = Object.assign(Object.assign({}, this.currentIndex), { index: this.currentIndex.index += 1 }), class: (this.currentIndex.index != 12 ? 'button next ' : ' btn-hidden button back') }, "Next")),
            h("div", { class: "results" },
