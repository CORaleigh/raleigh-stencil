...
export class WaterUsage {
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {Math.round(this.bath2.value*4.33*18)}
                </td>
                <td>
    ...
    <table>
        ...
        <thead>
            <tr>
                <th class="slider">Estimated Monthly Water Usage</th>
                <th>{Math.round(this.shower2.gallons+this.bath1.gallons+this.bath2.gallons+this.toilet.gallons+
                ...
                <th>{(this.shower2.ccfunits+this.bath1.ccfunits+this.bath2.ccfunits+this.toilet.ccfunits+
                    ...
                    this.leaking.ccfunits+this.indoor.ccfunits).toFixed(3)}</th>
            </tr>
        </thead>
